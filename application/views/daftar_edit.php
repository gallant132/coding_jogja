				...
				<div class="col-lg-6">
					...
					<form class="text-center border border-light p-5" method="post" action="<?php echo base_url() . 'Daftar/update'; ?>">
                        ...
                        <div class="form-row mb-4">
							...
							<select name="paket_bimbel" id="paket_bimbel" class="form-control" required>
                        ...
                        <div class="form-row mb-4">
                            ...
                            <select  name="pembayaran" id="pembayaran" class="form-control" required readonly>
